...
const Landing = () => {
  ...
  return (
    <PageShell className="flex flex-col">
      <div className="flex flex-1 flex-col justify-between px-5 py-10 sm:px-8 lg:mx-auto lg:max-w-3xl lg:px-12 lg:py-16">
        {/* Hero */}
        <div className="flex flex-1 flex-col items-start justify-center">
          <motion.p
            ...
            className="mb-4 text-xs font-medium uppercase tracking-widest text-muted-foreground sm:text-sm"
          >
          ...
          <motion.p
            ...
            className="mt-5 max-w-sm text-base leading-relaxed text-muted-foreground sm:text-lg"
          >
            Run with strangers. Get matched. Make friends. Show up.
          </motion.p>
        </div>
        ...
        >
          <h2 className="mb-5 font-serif text-foreground">How it works</h2>
