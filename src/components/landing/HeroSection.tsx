  ...
  return (
    <>
      ...
      <section ref={heroRef} className="relative w-full h-[100svh] overflow-hidden">
        ...
        {/* Hero content */}
        <div className="relative z-10 flex flex-col justify-end h-full px-6 md:px-10 pb-16 md:pb-24">
          <motion.h1
            initial={{ opacity: 0, y: 30 }}
            animate={{ opacity: 1, y: 0 }}
          ...
          <motion.h1
            ...
            className="font-serif text-white text-5xl md:text-7xl lg:text-8xl leading-[1.05] mt-1"
          >
            Find your crew.
          </motion.h1>
          <motion.p
          ...
          >
            A social running club for London. Every run, a new group. Every group, a story.
          </motion.p>
          <motion.button
            initial={{ opacity: 0, y: 20 }}
            animate={{ opacity: 1, y: 0 }}
            ...
            onClick={() => navigate("/signup")}
            className="mt-8 inline-flex items-center gap-2 self-start bg-white text-black px-7 py-3.5 text-base font-medium shadow-[4px_4px_0px_#fff] hover:shadow-[6px_6px_0px_#fff] transition-shadow duration-200"
          >
            Book your spot
            <ArrowRight size={18} />
          </motion.button>
