...
const ConversionSection = () => {
  ...
  return (
    <>
      {/* How It Works */}
      <section className="w-full bg-white py-20 md:py-28 px-6 md:px-10">
        <motion.h2
      ...
      {/* CTA Banner */}
      <section className="w-full bg-black py-24 md:py-32 px-6 md:px-10">
      ...
      {/* Footer */}
      <footer className="w-full bg-black px-6 md:px-10 py-10">
